...
export default function About() {
  return (
    <>
      <Head>
        <title>About — Ristic Labs</title>
        <meta name="description" content="Ristic Labs is the blockchain division of Ristic Innovations, founded in 2022 in Wilmington, Delaware." />
        <meta property="og:title" content="About Ristic Labs" />
        <meta property="og:description" content="Nurturing innovative blockchain solutions worldwide." />
      </Head>
      <SiteShell>
        ...
        <section className="mx-auto grid max-w-7xl gap-12 px-6 pb-24 lg:grid-cols-2">
          ...
          <div className="relative">
            ...
            <img src={aboutImage.src} alt="Blockchain lattice" loading="lazy" width={1280} height={1280} className="relative rounded-2xl border border-border" />
          </div>
        </section>
