...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Ristic Labs" },
      { name: "description", content: "Get in touch with Ristic Labs, the blockchain innovation division based in Wilmington, Delaware." },
      { property: "og:title", content: "Contact Ristic Labs" },
      { property: "og:description", content: "Let's build something on-chain together." },
    ],
  }),
  component: Contact,
});
