...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Services — Ristic Labs" },
      { name: "description", content: "Blockchain protocol engineering, smart contracts, dApp development, audits, and Web3 infrastructure." },
      { property: "og:title", content: "Services — Ristic Labs" },
      { property: "og:description", content: "End-to-end blockchain engineering and research services." },
    ],
  }),
  component: Services,
});
