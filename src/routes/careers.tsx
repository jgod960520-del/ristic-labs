...
export const Route = createFileRoute("/careers")({
  head: () => ({
    meta: [
      { title: "Careers — Ristic Labs" },
      { name: "description", content: "Join Ristic Labs. We're hiring blockchain developers, designers, engineers, and project managers." },
      { property: "og:title", content: "Careers — Ristic Labs" },
      { property: "og:description", content: "Open roles in blockchain, design, engineering, DevOps, QA, and PM." },
    ],
  }),
  component: Careers,
});
        ...
        <div className="overflow-hidden rounded-2xl border border-border">
          {roles.map((r, i) => (
            <Link
              key={r.t}
              to="/contact"
              className={`group flex items-center justify-between gap-6 p-6 transition-colors hover:bg-surface/80 md:p-8 ${
