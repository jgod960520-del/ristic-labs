...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Ristic Labs — Digital Innovative Ecosystem for Blockchain" },
      { name: "description", content: "Ristic Labs is the blockchain innovation division of Ristic Innovations, building next-generation applications and frameworks from Wilmington, Delaware." },
      { property: "og:title", content: "Ristic Labs — Blockchain Innovation" },
      { property: "og:description", content: "Nurturing innovative solutions within the blockchain technology domain." },
    ],
  }),
  component: Home,
});
